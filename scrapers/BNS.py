...
INDEX_URL_BNS = config["INDEX_URL_BNS"]
HEADERS = config["HEADERS"]

OUTPUT_DIR = os.path.join(REPO_ROOT, config["OUTPUT_DIR_BNS"])
...
def save_json(data: dict):
    ...
    filename = f"{data['section']}_BNS.json"
